...
open class AuthAPI {
     ...
     */
    open class func loginPost(body: Login, completion: @escaping ((_ data: AuthLoginResponse?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     */
    open class func loginPostWithRequestBuilder(body: Login) -> RequestBuilder<AuthLoginResponse> {
        let path = "/login"
  ...
  "message" : "message"
    ...
    /**
     ...
     - parameter body: (body) PasswordEdit 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func passwordEditPost(body: PasswordEdit, completion: @escaping ((_ data: SuccessResponse?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     - returns: RequestBuilder<SuccessResponse> 
     */
    open class func passwordEditPostWithRequestBuilder(body: PasswordEdit) -> RequestBuilder<SuccessResponse> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func registerPost(body: Register, completion: @escaping ((_ data: AuthRegisterResponse?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     */
    open class func registerPostWithRequestBuilder(body: Register) -> RequestBuilder<AuthRegisterResponse> {
        let path = "/register"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: body)
