...
open class ProfileAPI {
     ...
     */
    open class func avatarPost(image: URL, completion: @escaping ((_ data: ProfileUpdateMyAvatarResponse?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     */
    open class func avatarPostWithRequestBuilder(image: URL) -> RequestBuilder<ProfileUpdateMyAvatarResponse> {
        let path = "/avatar"
  ...
  "message" : "message"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func profilePut(body: User, completion: @escaping ((_ data: ProfileUpdateMyProfileResponse?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     */
    open class func profilePutWithRequestBuilder(body: User) -> RequestBuilder<ProfileUpdateMyProfileResponse> {
        let path = "/profile"
        let URLString = SwaggerClientAPI.basePath + path
